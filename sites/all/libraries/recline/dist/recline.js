    ...
    \
      ...
      <div class="menu-right"> \
        <div class="btn-group" data-toggle="buttons-checkbox"> \
          <a href="#" class="btn active" data-action="filters">Filtres</a> \
          <a href="#" class="btn active" data-action="fields">Champs</a> \
        </div> \
      </div> \
...
my.Fields = Backbone.View.extend({
  ...
  template: ' \
    ...
    <h3>Champs <a href="#" class="js-show-hide">+</a></h3> \
    {{#fields}} \
...
my.FilterEditor = Backbone.View.extend({
  ...
  template: ' \
    <div class="filters"> \
      <h3>Filtres</h3> \
      <a href="#" class="js-add-filter">Ajouter un filtre</a> \
      <form class="form-stacked js-add" style="display: none;"> \
        <fieldset> \
          <label>Type de filter</label> \
          <select class="filterType"> \
            <option value="term">Terme (text)</option> \
  ...
  template: ' \
    <form action="" method="GET" class="form-inline"> \
      <div class="input-prepend text-query"> \
        ...
        <input type="text" name="q" value="{{q}}" class="span2" placeholder="Recherche de données ..." class="search-query" /> \
      </div> \
